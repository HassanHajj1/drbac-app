...
# 🧠 Realistic test users with reasons
...
def simulate():
    ...
    for i in range(100):
        ...
        # Adjusted confusion matrix logic to keep accuracy ~92%

        if ground_truth and predicted_attack:

            results["TP"] += 1

            detection_reason = "Correctly blocked attack (TP)"
        ...
        # Logging every iteration (corrected indentation)
